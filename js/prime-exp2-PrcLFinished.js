          ...
          eventBus.on(event, function(e) {
            ...
            if(e.element.type.indexOf('StartEvent') != -1 && isMultipleStartEvents == true){
                ...
                for(i=0; i<seqFlowstobeClicked.length;i++){
                    ...
                    console.log('su an H executedan sonra seq flow click oldu mu '+isSeqFlowClickedAfterHExecutedOnce);
                    console.log('H kac kere execute edildi arka arkaya '+numofPrcDTaskHExecuted);
