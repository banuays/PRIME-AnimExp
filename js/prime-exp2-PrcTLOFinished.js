          ...
          eventBus.on(event, function(e) {
            ...
            if(e.element.type.indexOf('StartEvent') != -1 && isMultipleStartEvents == true){
                ...
                if(isStepAnimSelected==true/* && isJustFollowNext==true*/){
                    ...
                    for(var m=0; m < nodeSize; m++){
                        ...
                        if(nodetobeClicked[m].indexOf(selectedElementId) != -1){
                            ...
                            if(nodetoParse.id.indexOf('sid-8007DA64-E10A-4268-96FD-AC45E35FC049') != -1){//if task D is clicked on PrcD
                            ...
                            }else if(nodetoParse.id.indexOf('sid-359F15FF-4D9D-46B9-8A32-67C7360D3702') != -1){//if task E is clicked  on PrcD
                            ...
                            }else if(nodetoParse.id.indexOf('sid-7F7C9D6E-7851-43B2-AF58-6CBA79DE5216') != -1){//if task F is clicked  on PrcD
                            ...
                            }else if(nodetoParse.id.indexOf('sid-7FA8EE72-9027-4F57-BB83-532CB06CDAB9') != -1){//if task N is clicked  on PrcD
                            ...
                            }else if(nodetoParse.id.indexOf('sid-C7D8EDC6-0198-4465-9D42-6E07051D53E6') != -1){//if task G is clicked  on PrcD
                            ...
                            }else if(nodetoParse.id.indexOf('sid-EB98B6A4-4F1A-4720-A381-9E7557FEE0E2') != -1){//if task H is clicked  on PrcD
                            ...
                            else if(nodetoParse.id.indexOf('sid-D5556F60-9623-4A3A-9CE9-65FBD8172693') != -1){//if task M on PrcTL clicked
                                prcTLTaskMExecuted = true;
                                
                            }else if(nodetoParse.id.indexOf('sid-A8C54355-7159-41DA-891E-06395D6C88D4') != -1){//if task N on PrcTL clicked
                                prcTLTaskNExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-B9FCF1BF-2060-48F4-8667-E6BB8B0C2870') != -1){//if conv OR PrcTL clicked
                            ...
                            else if(nodetoParse.id.indexOf('sid-2CE90F39-ED85-4DD1-AA4A-19C39F8FB2FC') != -1){//if task A on PrcL clicked
                                prcLTaskAExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-0408842D-8C50-4639-8D12-B4DD2B96C719') != -1){//if task B on PrcL clicked
                                prcLTaskBExecuted = true;
                                
                            }else if(nodetoParse.id.indexOf('sid-D4CD6B85-92DA-45F6-BCCB-F9289102B5AA') != -1){//if first conv OR PrcL clicked
                            ...
                            else if(nodetoParse.id.indexOf('sid-EF09FCDB-A858-4214-86DF-86C0A81731DD') != -1){//if task J on PrcTLO clicked
                                prcTLOTaskJExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-0973BCCA-F992-4275-995A-88DBA619EE1A') != -1){//if task K on PrcTLO clicked
                                prcTLOTaskKExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-A7DB9084-23A3-4DD0-90E0-742C18616BFA') != -1){//if task L on PrcTLO clicked
                                prcTLOTaskLExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-84238CE5-A20F-4E5B-A6C8-B286CEABE731') != -1){//if inner conv OR PrcTLO clicked
                            ...
                            else if(nodetoParse.id.indexOf('sid-77C15100-15C9-4930-8137-D138944B7971') != -1){//if task A on PrcTLO clicked
                                prcTLOTaskAExecuted = true;
                                
                            }else if(nodetoParse.id.indexOf('sid-EFC66FA7-4D9A-4ED1-B058-95F91A413BD2') != -1){//if task G on PrcTLO clicked
                                prcTLOTaskGExecuted = true;
                                
                            }else if(nodetoParse.id.indexOf('sid-1D1409CE-7451-4384-A0BE-43FF8AB2426E') != -1){//if task I on PrcTLO clicked
                                prcTLOTaskIExecuted = true;
                                
                            }else if(nodetoParse.id.indexOf('sid-F684335A-2A88-4473-85EC-5ADF0A4C5BB9') != -1){//if task I on PrcTLO clicked
                                prcTLOTaskFExecuted = true;
                            }else if(nodetoParse.id.indexOf('sid-BDF017DE-8C00-4CE1-9A3F-C254D51AF719') != -1){//if outer conv OR PrcTLO clicked
                ...
                for(i=0; i<seqFlowstobeClicked.length;i++){
                    ...
                    if(selectedElementId.indexOf('sid-52B3E917-9AD2-4525-A360-F8D5549A835F') != -1 || selectedElementId.indexOf('sid-BE538472-BF58-44D2-8734-C9BB76B7BE23') != -1 || selectedElementId.indexOf('sid-C019D1A5-E3E2-463C-8BB0-997D54780B78') != -1){
                    ...
                    if(selectedElementId.indexOf('sid-A9CDD35B-3693-4DC7-A9E2-9E1E0E6D90DD') != -1){
...
function findNextObject(seqFlowToParse){
    ...
    if(nextObjectType.indexOf('EndEvent') != -1){
        ...
        if(nextObject.id.indexOf('sid-3A5661A0-3267-4EDC-B98F-EDD80290D10E') != -1){
            numofPrcDTaskDEnabled++;
        }else if(nextObject.id.indexOf('sid-940B7FE8-962D-4925-9872-FC566EB65609') != -1){
            numofPrcDTaskEEnabled++;//convergin XOR before E
        }else if(nextObject.id.indexOf('sid-E2AC263C-7EDB-47BE-BC88-86E7C484A833') != -1){
            numofPrcDTaskGEnabled++;
        }else if(nextObject.id.indexOf('sid-F0C72DE7-CF23-4695-B219-61A477D9145D') != -1){
        ...
        if(nextObject.id.indexOf('sid-C9870141-F3CA-413D-BFE3-DDB21B3D6362') != -1){
        ...
        else if(nextObject.id.indexOf('sid-B9FCF1BF-2060-48F4-8667-E6BB8B0C2870') != -1){
            if(prcTLTaskMExecuted == true && prcTLTaskNExecuted == true){
                ...
                markObject(nextObject.id, 'highlight-light');
                isJustFollowNext=true;
                console.log('extra push to nodetobeClicked for TL task M and N, do we ever come here?');
                nodetobeClicked.push(nextObject.id);
            }
        }
        //for Exp2 PrcL-Similar. When it comes to first converging OR, wait for A or B. 
        else if(nextObject.id.indexOf('sid-D4CD6B85-92DA-45F6-BCCB-F9289102B5AA') != -1){
        ...
        else if(nextObject.id.indexOf('sid-7C6432B3-1582-43C3-AB0B-2E8C25312353') != -1){
            markCleanObject(nextObject.id, 'highlight');
            markObjectAndSeqFlow(nextObject.id, 'highlight', 'lime');
            isCurObjInSelectedLane = false;
            var seqFlow = nextObject.get('outgoing');
        ...
        //for Exp2 PrcTLO (TwoLevel-OR). When it comes to converging OR, wait for J, K or L. 
        else if(nextObject.id.indexOf('sid-84238CE5-A20F-4E5B-A6C8-B286CEABE731') != -1){
            if(prcTLOTaskJExecuted == true && prcTLOTaskKExecuted == true && prcTLOTaskLExecuted == true){
                ...
                if(isInnerConvORInNodetoClickList == false){
                    console.log('extra push to nodetobeClicked for TLO J K L, do we ever come here?');
                    nodetobeClicked.push(nextObject.id);
                }
            }
        }
        ...
        else if(nextObject.id.indexOf('sid-BDF017DE-8C00-4CE1-9A3F-C254D51AF719') != -1){
